...
public class ShouldPersistNamespaceStateInCluster : AcceptanceTest
{
    private KongApi _api;
    private string _json;
    private IApiSwaggerRepository _swaggerRepository;

    public ShouldPersistNamespaceStateInCluster()
    {
    ...
    public void AndThenTheNamespaceStateIsPersistedInCluster()
    {
