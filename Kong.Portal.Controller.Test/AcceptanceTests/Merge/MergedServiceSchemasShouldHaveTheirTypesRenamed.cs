...
public class MergedServiceSchemasShouldHaveTheirTypesRenamed : AcceptanceTest
{
    ...
    private string _secondJson = @"
{
  ...
  ""components"": { ""schemas"": { ""TestPet"" : { } } }
    ...
    public void ThenNewTypeIsRenamedInMergedSchema()
    {
        _mergedJson.Contains("second-api_TestPet").Should().BeTrue();
    }
