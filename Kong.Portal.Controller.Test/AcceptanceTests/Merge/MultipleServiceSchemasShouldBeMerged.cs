...
public class MultipleServiceSchemasShouldBeMerged : AcceptanceTest
{
    ...
    private string _secondJson = @"
{
  ...
  ""components"": { ""schemas"": {} }
    ...
    public MultipleServiceSchemasShouldBeMerged()
    {
        ...
        dataRepository.Insert(Arg.Do<KongApiData>(x => _firstJson = x.Data.FromBrotliBase64()));
    ...
    public void ThenAllApiEndpointsArePresentInMergedSchema()
    {
        _firstJson.Contains("/v1/existing").Should().BeTrue();
        _firstJson.Contains("/v1/deploy").Should().BeTrue();
    }
